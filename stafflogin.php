<?php
include('login_s.php'); // Includes Login Script

if (isset($_SESSION['login_user3'])) {
    header("location: staffcontrolpanel.php"); // Redirecting to staff control panel
}
?>
?>
...
<html>
  ...
  <head>
    <title> staff login | College Canteen </title>
  </head>
