...
<head>
  ...
  <!-- Favicons -->
  <link href="images\icons\icons8-c-94.png" rel="icon">
...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-cente">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
      ...
      <h1 class="logo me-auto me-lg-0"><a href="index.php">College Canteen</a></h1>
  ...
  <main id="main">
    ...
    <section id="aboutt" class="aboutt">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2" data-aos="zoom-in" data-aos-delay="90">
            <div class="about-img">
    ...
    <section id="why-us" class="why-us">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="box" data-aos="zoom-in" data-aos-delay="90">
              <span>01</span>
              <h4>Good Vibes</h4>
    ...
    <div class="row menu-container" data-aos="fade-up" data-aos-delay="200">
      ...
      <div class="col-lg-6 menu-item filter-starters">
        ...
        <div class="menu-content">
          <a href="#"> Prawn Curry</a><span>₹300</span>
        </div>
        <div class="menu-ingredients">
          Authentic -style prawn curry made with local spices and coconut milk.
        </div>
      </div>
      ...
      <div class="col-lg-6 menu-item filter-salads">
        ...
        <div class="menu-content">
          <a href="#"> Fish Curry</a><span>₹280</span>
        </div>
        <div class="menu-ingredients">
          Spicy and tangy fish curry prepared in the traditional  style.
        </div>
      </div>
      ...
      <div class="col-lg-6 menu-item filter-specialty">
        ...
        <div class="menu-content">
          <a href="#"> Porotta with Beef Fry</a><span>₹220</span>
        </div>
        <div class="menu-ingredients">
      ...
      <div class="col-lg-6 menu-item filter-starters">
        ...
        <div class="menu-content">
          <a href="#"> Style Fish Fry</a><span>₹180</span>
        </div>
        <div class="menu-ingredients">
          Crispy and flavorful fish fry marinated with traditional  spices.
        </div>
      </div>
      ...
      <div class="col-lg-6 menu-item filter-salads">
        ...
        <div class="menu-ingredients">
          A traditional mixed vegetable curry with coconut and yogurt, a must-try dish from .
        </div>
      </div>
      ...
      <div class="col-lg-6 menu-item filter-salads">
        ...
        <div class="menu-content">
          <a href="#"> Parotta with Chicken Curry</a><span>₹200</span>
        </div>
        <div class="menu-ingredients">
      ...
      <div class="col-lg-6 menu-item filter-specialty">
        ...
        <div class="menu-content">
          <a href="#"> Style Beef Roast</a><span>₹280</span>
        </div>
        <div class="menu-ingredients">
          Tender and spicy beef roast cooked with traditional  spices and flavors.
        </div>
      </div>
    ...
    <div class="row" data-aos="fade-up" data-aos-delay="100">
      <div class="col-lg-3">
        <ul class="nav nav-tabs flex-column">
          <li class="nav-item">
            <a class="nav-link active show" data-bs-toggle="tab" href="#tab-1"> Fish Curry</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="tab" href="#tab-2"> Sadya</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="tab" href="#tab-3"> Prawn Roast</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="tab" href="#tab-4"> Beef Fry</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="tab" href="#tab-5"> Banana Fritters</a>
          </li>
        </ul>
      </div>
        ...
        <div class="tab-content">
          <div class="tab-pane active show" id="tab-1">
            <div class="row">
              <div class="col-lg-8 details order-2 order-lg-1">
                <h3> Fish Curry</h3>
                <p class="fst-italic">Spicy and tangy fish curry prepared in the traditional  style.</p>
                <p>Authentic -style fish curry made with local spices and coconut milk. Perfectly pairs with steamed rice or appam.</p>
              </div>
              <div class="col-lg-4 text-center order-1 order-lg-2">
                <img src="images/-fish-curry.jpg" alt=" Fish Curry" class="img-fluid">
              </div>
            </div>
          </div>
          <div class="tab-pane" id="tab-2">
            <div class="row">
              <div class="col-lg-8 details order-2 order-lg-1">
                <h3> Sadya</h3>
                <p class="fst-italic">A traditional  feast served on a banana leaf with a variety of vegetarian dishes.</p>
                <p> Sadya is a wholesome vegetarian meal with an assortment of curries, pickles, papadam, and desserts served on a fresh banana leaf.</p>
              </div>
              <div class="col-lg-4 text-center order-1 order-lg-2">
                <img src="images/-sadya.jpg" alt=" Sadya" class="img-fluid">
              </div>
            </div>
          </div>
          <div class="tab-pane" id="tab-3">
            <div class="row">
              <div class="col-lg-8 details order-2 order-lg-1">
                <h3> Prawn Roast</h3>
                <p class="fst-italic">Delicious and spicy prawn roast cooked with traditional  spices.</p>
                <p> Prawn Roast is a flavorful dish made with succulent prawns marinated in a blend of aromatic spices and pan-roasted to perfection.</p>
              </div>
              <div class="col-lg-4 text-center order-1 order-lg-2">
                <img src="images/-prawn-roast.jpg" alt=" Prawn Roast" class="img-fluid">
              </div>
            </div>
          </div>
          <div class="tab-pane" id="tab-4">
            <div class="row">
              <div class="col-lg-8 details order-2 order-lg-1">
                <h3> Beef Fry</h3>
                <p class="fst-italic">Spicy and aromatic beef fry prepared in the traditional  style.</p>
                <p> Beef Fry is a popular dish made with tender beef pieces cooked with spices, onions, and curry leaves. It is a perfect side dish for rice or appam.</p>
              </div>
              <div class="col-lg-4 text-center order-1 order-lg-2">
                <img src="images/-beef-fry.jpg" alt=" Beef Fry" class="img-fluid">
              </div>
            </div>
          </div>
          <div class="tab-pane" id="tab-5">
            <div class="row">
              <div class="col-lg-8 details order-2 order-lg-1">
                ...
                <p> Banana Fritters, also known as Pazham Pori, are a popular tea-time snack made with ripe bananas dipped in a batter of flour, sugar, and spices, and deep-fried until golden brown.</p>
              </div>
              <div class="col-lg-4 text-center order-1 order-lg-2">
                <img src="images/-banana-fritters.jpg" alt=" Banana Fritters" class="img-fluid">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="swiper-slide">
          <div class="row event-item">
            ...
            <div class="col-lg-6 pt-4 pt-lg-0 content">
              <h3>Traditional -Style Birthday Parties</h3>
              <div class="price">
                <p><span>189</span></p>
              </div>
              <p class="fst-italic">
                Experience the essence of  with our traditional-style birthday parties.
              </p>
              <ul>
                <li><i class="bi bi-check-circled"></i> Authentic  cuisine and delicacies.</li>
                <li><i class="bi bi-check-circled"></i> -themed decorations and ambiance.</li>
                <li><i class="bi bi-check-circled"></i> Traditional  music and cultural performances.</li>
              </ul>
              <p>
                Celebrate your special day in a truly -style way, immersing yourself in the rich culture and traditions of the region.
              </p>
            </div>
          </div>
        ...
        <div class="swiper-slide">
          <div class="row event-item">
            ...
            <div class="col-lg-6 pt-4 pt-lg-0 content">
              ...
              <p class="fst-italic">
                Experience the vibrant and colorful Bcom Fest with a touch of  culture.
              </p>
              <ul>
                <li><i class="bi bi-check-circled"></i> Exciting competitions and cultural events.</li>
                <li><i class="bi bi-check-circled"></i> Traditional  performances and art forms.</li>
                <li><i class="bi bi-check-circled"></i> Delicious  cuisine and snacks.</li>
              </ul>
              <p>
                Immerse yourself in the unique blend of academic excellence and 's cultural extravaganza at the  Bcom Fest.
              </p>
            </div>
          </div>
        </div><!-- End testimonial item -->
        ...
        <div class="swiper-slide">
          <div class="row event-item">
            ...
            <div class="col-lg-6 pt-4 pt-lg-0 content">
              ...
              <p class="fst-italic">
                Experience the creativity and technology at the  Bca Fest.
              </p>
              <ul>
                ...
                <li><i class="bi bi-check-circled"></i> Authentic  cuisine and refreshments.</li>
              </ul>
              <p>
                Join us to explore the exciting world of technology and immerse yourself in the warmth of 's hospitality at the  Bca Fest.
              </p>
            </div>
          </div>
        </div><!-- End testimonial item -->
...
<h2 align="center"> O U R T E A M </h2>
    ...
    </section><!-- <div class="error-message"></div> -->
