...
foreach ($_SESSION["cart"] as $keys => $values) {
    ...
    if ($result) {
        // Get the corresponding order ID
        $order_ID = mysqli_insert_id($conn);
        $orderIDs[] = $order_ID;
        // Use the order ID for further processing or display
...
// Encode the order IDs as a comma-separated string
$orderIDsString = implode(',', $orderIDs);
$orderIDsParam = implode(',', $orderIDs);
$onlinePayURL = "onlinepay.php?order_IDs=$orderIDsParam";
$CODURL = "COD.php?order_IDs=$orderIDsParam";
...
<a href="<?php echo $onlinePayURL; ?>"><button class="btn btn-success"><span class="glyphicon glyphicon-credit-card"></span> Pay Online</button></a>
<a href="<?php echo $CODURL; ?>"><button class="btn btn-success"><span class="glyphicon glyphicon-"></span> Cash On Delivery</button></a>
</h1>
